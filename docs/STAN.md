...
| [4](etapy/etap-4.md) | Frontend gry lokalnej (MVP) | **W TRAKCIE** — ekran gry złożony z komponentów, zatwierdzenie kości i zapis kategorii wołają API; wyjście z gry, `/games` w nowym designie i karta niedokończonej gry hosta (PR #8); zakończona gra zostaje na ekranie gry z zablokowanymi kośćmi; log gry pod graczami, ekran gry dopasowany do telefonów; brakuje ekranu końca z wynikami i lobby w nowym designie; otwarte: poprawianie kości po „Confirm” (serwer odrzuca drugi `roll`) |
