...
| [3](etapy/etap-3.md) | API i baza | **W TRAKCIE** ← tu jesteśmy (endpointy działają; 2026-09-25 doszły wynik końcowy w bazie i `GET /games/:id/events`; do zrobienia: `join` tylko dla hosta, jedna gra na hosta, `maxAge` ciasteczka nieustalone, restart serwera nieprzećwiczony) |
